	...
	return (util = {
		require_urns: function(locale) {
			return new Promise(function(resolve, reject) {
				require([
					"./current/immetingen/lookup/" + locale, 
					"./current/imsikb0101/lookup/" + locale
		...
		guess: require("./guess"),
		tables: {
			immetingen: require("json!./current/immetingen-all"),
			imsikb0101: require("json!./current/imsikb0101-all")
		}
	});
});
